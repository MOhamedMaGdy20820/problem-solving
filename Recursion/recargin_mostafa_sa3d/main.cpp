...
void generrateBinary(ll len ,string s= "")
{
    if(len==0) {cout<<s<<endl;return;}

    generrateBinary(len-1,s+'0');
    generrateBinary(len-1,s+'1');

}

void generrateTernary(ll len ,string s= "")
{
    if(len==0) {cout<<s<<endl;return;}

    generrateBinary(len-1,s+'0');
    generrateBinary(len-1,s+'1');
    generrateBinary(len-1,s+'2');
